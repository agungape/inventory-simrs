                                ...
                                <div class="col-12 mb-3">
                                    <ul class="nav nav-tabs" id="mcuTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="tht-tab" data-bs-toggle="tab" data-bs-target="#tht" type="button" role="tab">Pemeriksaan THT</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="gigi-tab" data-bs-toggle="tab" data-bs-target="#gigi" type="button" role="tab">Gigi & Mulut</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="thorax-tab" data-bs-toggle="tab" data-bs-target="#thorax" type="button" role="tab">Thorax</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="abdomen-tab" data-bs-toggle="tab" data-bs-target="#abdomen" type="button" role="tab">Abdomen</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="muskulo-tab" data-bs-toggle="tab" data-bs-target="#muskulo" type="button" role="tab">Muskuloskeletal</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="neuro-tab" data-bs-toggle="tab" data-bs-target="#neuro" type="button" role="tab">Neurologis</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="neuro-khusus-tab" data-bs-toggle="tab" data-bs-target="#neuro-khusus" type="button" role="tab">Neurologis Khusus</button>
                                        </li>
                                    </ul>
                                        ...
                                        <div class="tab-pane fade show active" id="tht" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="daun_telinga" value="normal" data-target="daun_telinga_tidak_normal">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="daun_telinga" value="tidak normal" data-target="daun_telinga_tidak_normal">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="daun_telinga_tidak_normal" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>

                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Lubang Telinga</label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="lubang_telinga" value="normal" data-target="lubang_telinga_tidak_normal">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="lubang_telinga" value="tidak normal" data-target="lubang_telinga_tidak_normal">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="lubang_telinga_tidak_normal" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>

                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Membran Tymphani</label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="membran_tymphani" value="normal" data-target="membran_tymphani_tidak_normal">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="membran_tymphani" value="tidak normal" data-target="membran_tymphani_tidak_normal">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="membran_tymphani_tidak_normal" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>

                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Hidung Septum Concha</label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="hidung_septum_concha" value="normal" data-target="hidung_septum_concha_tidak_normal">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="hidung_septum_concha" value="tidak normal" data-target="hidung_septum_concha_tidak_normal">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="hidung_septum_concha_tidak_normal" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>

                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Faring</label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="faring" value="normal" data-target="faring_tidak_normal">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="faring" value="tidak normal" data-target="faring_tidak_normal">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="faring_tidak_normal" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>

                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Tonsil</label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="tonsil" value="normal" data-target="tonsil_tidak_normal">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="tonsil" value="tidak normal" data-target="tonsil_tidak_normal">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="tonsil_tidak_normal" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="gigi" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="lidah" value="normal" data-target="lidah_tidak_normal">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="lidah" value="tidak normal" data-target="lidah_tidak_normal">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="lidah_tidak_normal" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>

                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Gusi</label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="gusi" value="normal" data-target="gusi_tidak_normal">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="gusi" value="tidak normal" data-target="gusi_tidak_normal">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="gusi_tidak_normal" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>

                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Gigi</label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="gigi" value="normal" data-target="gigi_tidak_normal">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="gigi" value="tidak normal" data-target="gigi_tidak_normal">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="gigi_tidak_normal" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>

                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Leher</label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="leher" value="normal" data-target="leher_tidak_normal">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="leher" value="tidak normal" data-target="leher_tidak_normal">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="leher_tidak_normal" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <div id="selectedTeeth" class="selected-teeth-display">
                                                                ...
                                                                <div class="mt-4">
                                                                    ...
                                                                    <div id="teethProblemsList" class="teeth-problems-list">
                                                                        <!-- Data akan ditampilkan di sini -->
                                                                    </div>
                                                                </div>

                                                                <!-- Input tersembunyi untuk menyimpan data -->
                                                                <input type="hidden" name="teeth_problems_data" id="teethProblemsData">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="thorax" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="bentuk" value="normal" data-target="bentuk_tidak_normal">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="bentuk" value="tidak normal" data-target="bentuk_tidak_normal">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="bentuk_tidak_normal" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>

                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Inspeksi</label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="inspeksi" value="normal" data-target="inspeksi_tidak_normal">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="inspeksi" value="tidak normal" data-target="inspeksi_tidak_normal">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="inspeksi_tidak_normal" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>

                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Palpasi</label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="palpasi" value="normal" data-target="palpasi_tidak_normal">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="palpasi" value="tidak normal" data-target="palpasi_tidak_normal">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="palpasi_tidak_normal" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>

                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Perkusi</label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="perkusi" value="normal" data-target="perkusi_tidak_normal">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="perkusi" value="tidak normal" data-target="perkusi_tidak_normal">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="perkusi_tidak_normal" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>

                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Aukultasi</label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="aukultasi" value="normal" data-target="aukultasi_tidak_normal">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="aukultasi" value="tidak normal" data-target="aukultasi_tidak_normal">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="aukultasi_tidak_normal" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>

                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Lainnya</label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="lainnya" value="normal" data-target="lainnya_tidak_normal">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="lainnya" value="tidak normal" data-target="lainnya_tidak_normal">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="lainnya_tidak_normal" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="abdomen" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Bentuk</label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="bentuk_abdomen" value="normal" data-target="bentuk_tidak_normal_abdomen">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="bentuk_abdomen" value="tidak normal" data-target="bentuk_tidak_normal_abdomen">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="bentuk_tidak_normal_abdomen" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>

                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Palpasi</label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="palpasi_abdomen" value="normal" data-target="palpasi_tidak_normal_abdomen">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="palpasi_abdomen" value="tidak normal" data-target="palpasi_tidak_normal_abdomen">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="palpasi_tidak_normal_abdomen" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>

                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Perkusi</label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="perkusi_abdomen" value="normal" data-target="perkusi_tidak_normal_abdomen">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="perkusi_abdomen" value="tidak normal" data-target="perkusi_tidak_normal_abdomen">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="perkusi_tidak_normal_abdomen" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="neuro" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="reflek_fisologis" value="normal" data-target="reflek_fisologis_tidak_normal">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="reflek_fisologis" value="tidak normal" data-target="reflek_fisologis_tidak_normal">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="reflek_fisologis_tidak_normal" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="kekuatan_motorik" value="normal" data-target="kekuatan_motorik_tidak_normal">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="kekuatan_motorik" value="tidak normal" data-target="kekuatan_motorik_tidak_normal">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="kekuatan_motorik_tidak_normal" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>

                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Sensorik</label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="sensorik" value="normal" data-target="sensorik_tidak_normal">
                                                        <label class="form-check-label">Normal</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="sensorik" value="tidak normal" data-target="sensorik_tidak_normal">
                                                        <label class="form-check-label">Tidak Normal</label>
                                                    </div>
                                                    <textarea class="form-control mt-2 keterangan-textarea" name="sensorik_tidak_normal" placeholder="Keterangan jika tidak normal..." style="display: none;"></textarea>
                                                </div>
                                ...
                                <div class="col-12 mb-4">
                                    <div class="d-flex justify-content-between">
                                        <div class="btn-group" role="group">
                                            <button type="button" class="btn btn-outline-secondary" onclick="showPreviousTab()">
                                                <i class="fas fa-chevron-left me-1"></i> Tab Sebelumnya
                                            </button>
                                            <button type="button" class="btn btn-outline-secondary" onclick="showNextTab()">
...
@push('scripts')
    ...
    <script>
        ...
        const teethData = [
            // Gigi atas (1-16)
            { number: 18, name: "Molar 3 Atas Kanan", row: "upper", position: 0 },
            { number: 17, name: "Molar 2 Atas Kanan", row: "upper", position: 1 },
            { number: 16, name: "Molar 1 Atas Kanan", row: "upper", position: 2 },
            { number: 15, name: "Premolar 2 Atas Kanan", row: "upper", position: 3 },
            { number: 14, name: "Premolar 1 Atas Kanan", row: "upper", position: 4 },
            { number: 13, name: "Caninus Atas Kanan", row: "upper", position: 5 },
            { number: 12, name: "Incisivus 2 Atas Kanan", row: "upper", position: 6 },
            { number: 11, name: "Incisivus 1 Atas Kanan", row: "upper", position: 7 },
            { number: 21, name: "Incisivus 1 Atas Kiri", row: "upper", position: 8 },
            { number: 22, name: "Incisivus 2 Atas Kiri", row: "upper", position: 9 },
            { number: 23, name: "Caninus Atas Kiri", row: "upper", position: 10 },
            { number: 24, name: "Premolar 1 Atas Kiri", row: "upper", position: 11 },
            { number: 25, name: "Premolar 2 Atas Kiri", row: "upper", position: 12 },
            { number: 26, name: "Molar 1 Atas Kiri", row: "upper", position: 13 },
            { number: 27, name: "Molar 2 Atas Kiri", row: "upper", position: 14 },
            { number: 28, name: "Molar 3 Atas Kiri", row: "upper", position: 15 },

            // Gigi bawah (31-48)
            { number: 48, name: "Molar 3 Bawah Kiri", row: "lower", position: 0 },
            { number: 47, name: "Molar 2 Bawah Kiri", row: "lower", position: 1 },
            { number: 46, name: "Molar 1 Bawah Kiri", row: "lower", position: 2 },
            { number: 45, name: "Premolar 2 Bawah Kiri", row: "lower", position: 3 },
            { number: 44, name: "Premolar 1 Bawah Kiri", row: "lower", position: 4 },
            { number: 43, name: "Caninus Bawah Kiri", row: "lower", position: 5 },
            { number: 42, name: "Incisivus 2 Bawah Kiri", row: "lower", position: 6 },
            { number: 41, name: "Incisivus 1 Bawah Kiri", row: "lower", position: 7 },
            { number: 31, name: "Incisivus 1 Bawah Kanan", row: "lower", position: 8 },
            { number: 32, name: "Incisivus 2 Bawah Kanan", row: "lower", position: 9 },
            { number: 33, name: "Caninus Bawah Kanan", row: "lower", position: 10 },
            { number: 34, name: "Premolar 1 Bawah Kanan", row: "lower", position: 11 },
            { number: 35, name: "Premolar 2 Bawah Kanan", row: "lower", position: 12 },
            { number: 36, name: "Molar 1 Bawah Kanan", row: "lower", position: 13 },
            { number: 37, name: "Molar 2 Bawah Kanan", row: "lower", position: 14 },
            { number: 38, name: "Molar 3 Bawah Kanan", row: "lower", position: 15 },
        ];
